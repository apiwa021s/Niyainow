...
/**
 * Shared between app/loading.tsx (full-route fallback, cold navigation) and
 * app/page.tsx (inner Suspense fallbacks once the shell is already on
 * screen) so the two never drift into visibly different skeletons.
 */
export function HomeHeroSkeleton() {
  return (
    <div aria-hidden className="grid gap-3">
      <section className="overflow-hidden rounded-(--r-lg) border border-border bg-surface">
