...
export const translationWorkspaces = pgTable("translation_workspaces", {
  ...
  profileGenerationStage: varchar("profile_generation_stage", { length: 32 }),
  profileGenerationCheckpoint: jsonb("profile_generation_checkpoint").$type<Record<string, unknown>>().default({}).notNull(),
  profileGenerationError: text("profile_generation_error"),
