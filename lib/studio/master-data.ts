...
export const PRIMARY_GENRES = master([
  {
    ...
    nameTh: "แอ็กชัน",
    nameEn: "Action",
    descriptionTh: "ฉากปะทะรวดเร็ว การต่อสู้เข้มข้น และเดิมพันสูง",
    descriptionEn: "Fast-paced conflicts, intense battles, and high stakes.",
    icon: "⚔️",
  },
  {
    id: "adventure",
    nameTh: "ผจญภัย",
    nameEn: "Adventure",
    descriptionTh: "การเดินทางสู่สถานที่ใหม่ ภารกิจท้าทาย และการค้นพบครั้งสำคัญ",
    descriptionEn: "Journeys, challenging quests, and discoveries in unfamiliar places.",
    icon: "🧭",
  },
  {
    id: "romance",
    nameTh: "โรแมนซ์",
    nameEn: "Romance",
    descriptionTh: "เรื่องราวความรักและความสัมพันธ์ที่เติบโตผ่านบททดสอบต่าง ๆ",
    descriptionEn: "Stories centered on love, relationships, and emotional growth.",
    icon: "❤️",
  },
  {
    id: "fantasy",
    nameTh: "แฟนตาซี",
    nameEn: "Fantasy",
    descriptionTh: "โลกเวทมนตร์ สิ่งมีชีวิตมหัศจรรย์ และการผจญภัยเหนือจินตนาการ",
    descriptionEn: "Magic, wondrous beings, and adventures beyond the ordinary world.",
    icon: "🔮",
  },
  {
    id: "sci-fi",
    nameTh: "ไซไฟ",
    nameEn: "Sci-Fi",
    descriptionTh: "เทคโนโลยี อวกาศ และโลกอนาคตที่ท้าทายความเป็นไปได้",
    descriptionEn: "Technology, space, and future worlds that explore new possibilities.",
    icon: "🚀",
  },
  {
    id: "mystery",
    nameTh: "สืบสวน / ลึกลับ",
    nameEn: "Mystery",
    descriptionTh: "ปริศนา เบาะแส และความจริงที่ค่อย ๆ ถูกเปิดเผย",
    descriptionEn: "Puzzles, clues, and hidden truths waiting to be uncovered.",
    icon: "🔎",
  },
  {
    id: "thriller",
    nameTh: "ระทึกขวัญ",
    nameEn: "Thriller",
    descriptionTh: "คดีอาชญากรรม การไล่ล่า และสถานการณ์กดดันที่คาดเดาไม่ได้",
    descriptionEn: "Crime, pursuit, and suspenseful situations with unpredictable turns.",
    icon: "🔪",
  },
  {
    id: "horror",
    nameTh: "สยองขวัญ",
    nameEn: "Horror",
    descriptionTh: "บรรยากาศน่าหวาดหวั่น ภัยคุกคาม และความกลัวที่ซ่อนอยู่",
    descriptionEn: "Unsettling atmospheres, lurking threats, and stories built around fear.",
    icon: "👻",
  },
  {
    id: "historical",
    nameTh: "ย้อนยุค / ประวัติศาสตร์",
    nameEn: "Historical",
    descriptionTh: "เรื่องราวในอดีตที่ถ่ายทอดยุคสมัย วัฒนธรรม และวิถีชีวิต",
    descriptionEn: "Stories grounded in past eras, cultures, and ways of life.",
    icon: "🏯",
  },
  {
    id: "contemporary",
    nameTh: "ร่วมสมัย",
    nameEn: "Contemporary",
    descriptionTh: "เรื่องราวในสังคมปัจจุบันที่ใกล้ตัวและสะท้อนชีวิตจริง",
    descriptionEn: "Present-day stories that reflect modern society and everyday life.",
    icon: "🏙️",
  },
  {
    id: "drama",
    nameTh: "ดราม่า",
    nameEn: "Drama",
    descriptionTh: "ความขัดแย้งทางอารมณ์ ครอบครัว และชีวิตที่เข้มข้น",
    descriptionEn: "Emotionally driven stories about conflict, family, and life-changing choices.",
    icon: "🎭",
  },
  {
    id: "comedy",
    nameTh: "คอมเมดี้",
    nameEn: "Comedy",
    descriptionTh: "เรื่องราวชวนยิ้ม จังหวะสนุก และสถานการณ์อารมณ์ดี",
    descriptionEn: "Lighthearted stories filled with humor and playful situations.",
    icon: "😄",
  },
  {
    id: "slice-of-life",
    nameTh: "ชีวิตประจำวัน",
    nameEn: "Slice of Life",
    descriptionTh: "เรื่องราวเรียบง่ายที่ถ่ายทอดความหมายและรายละเอียดของชีวิตประจำวัน",
    descriptionEn: "Grounded stories that find meaning in the details of everyday life.",
    icon: "☕",
  },
  {
    id: "sports",
    nameTh: "กีฬา",
    nameEn: "Sports",
    descriptionTh: "การแข่งขัน การฝึกฝน ทีมเวิร์ก และการก้าวข้ามขีดจำกัด",
    descriptionEn: "Competition, training, teamwork, and the pursuit of athletic goals.",
    icon: "🏆",
  },
  {
    id: "martial-arts",
    nameTh: "ศิลปะการต่อสู้",
    nameEn: "Martial Arts",
    descriptionTh: "วิชาต่อสู้ การฝึกฝน และศึกประลองเพื่อพิสูจน์ฝีมือ",
    descriptionEn: "Combat disciplines, training, and contests of martial skill.",
    icon: "🥋",
  },
  {
    id: "system",
    nameTh: "ระบบ / เกม",
    nameEn: "System / GameLit",
    descriptionTh: "ภารกิจ ค่าสถานะ สกิล และการเติบโตภายใต้กลไกของระบบหรือเกม",
    descriptionEn: "Quests, stats, skills, and progression governed by game-like systems.",
    icon: "📊",
  },
  {
    id: "apocalypse",
    nameTh: "วันสิ้นโลก",
    nameEn: "Apocalypse",
    descriptionTh: "การเอาชีวิตรอดเมื่อสังคมและกฎเกณฑ์เดิมพังทลาย",
    descriptionEn: "Survival after society and the familiar world have collapsed.",
    icon: "☄️",
  },
]);
