...
export const genres: Genre[] = [
  ...
  { slug: "mystery", name: "Mystery", thaiName: "สืบสวน / ลึกลับ", description: "ปริศนา เบาะแส และความจริงที่ค่อย ๆ เผย", count: 356 },
  { slug: "thriller", name: "Thriller", thaiName: "ระทึกขวัญ", description: "การไล่ล่าและสถานการณ์กดดันที่คาดเดาไม่ได้", count: 318 },
  { slug: "horror", name: "Horror", thaiName: "สยองขวัญ", description: "บรรยากาศกดดัน ความลับ และภัยที่มองไม่เห็น", count: 248 },
  { slug: "historical", name: "Historical", thaiName: "ย้อนยุค / ประวัติศาสตร์", description: "เรื่องราวในอดีตผ่านยุคสมัยและวัฒนธรรมที่แตกต่าง", count: 465 },
  { slug: "contemporary", name: "Contemporary", thaiName: "ร่วมสมัย", description: "เรื่องราวใกล้ตัวในสังคมและชีวิตปัจจุบัน", count: 538 },
  { slug: "drama", name: "Drama", thaiName: "ดราม่า", description: "ความขัดแย้งทางอารมณ์ ครอบครัว และชีวิตที่เข้มข้น", count: 612 },
  { slug: "comedy", name: "Comedy", thaiName: "คอมเมดี้", description: "อ่านสบาย จังหวะสนุก และตัวละครมีเสน่ห์", count: 402 },
  { slug: "slice-of-life", name: "Slice of Life", thaiName: "ชีวิตประจำวัน", description: "เรื่องเรียบง่ายที่ถ่ายทอดรายละเอียดและความหมายของชีวิต", count: 333 },
  { slug: "sports", name: "Sports", thaiName: "กีฬา", description: "การแข่งขัน การฝึกฝน ทีมเวิร์ก และการก้าวข้ามขีดจำกัด", count: 214 },
  { slug: "martial-arts", name: "Martial Arts", thaiName: "ศิลปะการต่อสู้", description: "วิชาต่อสู้ การฝึกฝน และศึกแห่งศักดิ์ศรี", count: 644 },
  { slug: "system", name: "System / GameLit", thaiName: "ระบบ / เกม", description: "ภารกิจ ค่าสถานะ และการเติบโตภายใต้กลไกของระบบ", count: 920 },
...
const rawNovels: Novel[] = [
  ...
  },
  {
    ...
    genres: ["slice-of-life", "horror", "mystery"],
