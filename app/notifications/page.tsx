...
export default async function NotificationsPage() {
  ...
  return <PageShell className="space-y-6"><header className="border-y border-border py-5 sm:py-6"><p className="editorial-kicker">สถานะฟีเจอร์</p><h1 className="mt-1 text-h1 font-semibold sm:text-display">การแจ้งเตือน</h1></header><NotificationsPanel followingCount={summary.followingCount} /></PageShell>;
}
