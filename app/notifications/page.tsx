...
export default async function NotificationsPage() {
  ...
  return <PageShell className="space-y-6"><header><p className="editorial-kicker">สถานะฟีเจอร์</p><h1 className="mt-1 font-serif text-3xl font-semibold">การแจ้งเตือน</h1></header><NotificationsPanel followingCount={summary.followingCount} /></PageShell>;
}
