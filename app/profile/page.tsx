...
export default async function ProfilePage() {
  ...
  return <PageShell className="space-y-6"><header><p className="editorial-kicker">บัญชีและการอ่าน</p><h1 className="mt-1 text-3xl font-semibold">โปรไฟล์</h1></header><ProfilePanel user={user} summary={summary} /></PageShell>;
}
