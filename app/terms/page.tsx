...
export const metadata = pageMetadata({
  ...
  description: "ข้อกำหนดการเข้าถึงบัญชี เนื้อหา และฟีเจอร์ของแพลตฟอร์ม NovelNow",
  path: "/terms"
});
...
const termsSections = [
  ...
  },
  {
    ...
    body: ["ขณะนี้ระบบชำระเงิน กระเป๋าเหรียญ และการซื้อเนื้อหายังไม่เปิดให้บริการ NovelNow จะประกาศเงื่อนไขที่เกี่ยวข้องก่อนเปิดฟีเจอร์ดังกล่าว และจะไม่ถือว่าข้อความทดลองในระบบเป็นยอดเงินหรือสิทธิ์ที่แลกคืนได้"]
  },
  {
  ...
  return (
    <PageShell className="max-w-6xl">
      <PageHeader
        eyebrow="LEGAL / TERMS"
        title="ข้อกำหนดการใช้งาน"
        description="หลักเกณฑ์สำหรับการอ่าน การใช้บัญชี และการดูแลพื้นที่ร่วมกันของ NovelNow"
      />
